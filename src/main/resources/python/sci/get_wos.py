...
def exportfile(markfrom,markto,count,fromyear):
    ...
    with open(os.getcwd() + "\\result\\"+str(fromyear)+".txt", "ab+") as w:
...
def getwos(fromyear,toyear,art_type):
    ...
    while fromyear<=toyear:
        ...
        while markto<=totalNum:
         exportfile(markfrom,markto,count,fromyear)
         markfrom += 500
...
if __name__ == '__main__':
    ...
    #传入参数
    print(os.getcwd())
    getwos(int(sys.argv[1]),int(sys.argv[2]),sys.argv[3])